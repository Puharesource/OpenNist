...
internal static class Nfiq2PortableGrayMapCodec
{
    public static (byte[] Pixels, int Width, int Height) Read(string path)
    {
        ...
        {
            throw new NotSupportedException($"'{path}' is not a binary Portable Gray Map image.");
        }
        ...
        if (maxValue != 255)
        {
            throw new NotSupportedException($"'{path}' does not contain 8-bit grayscale data.");
        }
