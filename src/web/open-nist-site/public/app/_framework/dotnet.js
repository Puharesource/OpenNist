...
function x(e, t, o) {
  return function (...n) {
    try {
      ...
      t(o ? JSON.stringify({ method: e, payload: r, arguments: n.slice(1) }) : [e + r, ...n.slice(1)])
    } catch (e) {
...
function j(e, t, o) {
  ;((f = t), (g = e), (m = { ...t }))
  const n = `${o}/console`.replace("https://", "wss://").replace("http://", "ws://")
  ;((u = new WebSocket(n)),
...
function D() {
  ...
  if (!e)
    if (Pe.preferredIcuAsset) Pe.diagnosticTracing && b("ICU data archive(s) available, disabling invariant mode")
    else {
      if (
      ...
      ;(Pe.diagnosticTracing && b("ICU data archive(s) not available, using invariant globalization mode"),
        (e = !0),
...
function O(e) {
  ...
  if ((null === (t = e.resources) || void 0 === t ? void 0 : t.icu) && "invariant" != e.globalizationMode) {
    const t =
        ...
        (ke
          ? globalThis.navigator && globalThis.navigator.languages && globalThis.navigator.languages[0]
...
async function k(e, t) {
  try {
    ...
    if (Se) {
      ...
      ;(p || ((h = Ne.require("url")), (p = Ne.require("fs"))), n && (e = h.fileURLToPath(e)))
...
const U = /^[a-zA-Z][a-zA-Z\d+\-.]*?:\/\//,
  P = /[a-zA-Z]:[\\/]/
function M(e) {
  return Se || Ie ? e.startsWith("/") || e.startsWith("\\") || -1 !== e.indexOf("///") || P.test(e) : U.test(e)
}
let L,
  N = 0
const $ = [],
...
function K(e, t, o) {
  ;(null != t || (t = []), Be(1 == t.length, `Expect to have one ${o} asset in resources`))
  const n = t[0]
...
function Y(e) {
  ...
  if (t && !t.resolvedUrl)
    if (((t.resolvedUrl = Pe.locateFile(t.name)), F[t.behavior])) {
      const e = ge(t)
      e
        ? ("string" != typeof e && Be(!1, "loadBootResource response for 'dotnetjs' type should be a URL string"),
          (t.resolvedUrl = e))
  ...
  if (!te) {
    ...
    try {
      const e = [],
        ...
        o = (e, t) => {
          ;(!Z[e.behavior] && G(e) && Pe.expected_instantiated_assets_count++,
            !H[e.behavior] && G(e) && (Pe.expected_downloaded_assets_count++, t.push(se(e))))
        }
          ...
          if (t.buffer) {
            if (!Z[t.behavior]) {
              ;((t.buffer && "object" == typeof t.buffer) ||
                Be(!1, "asset buffer must be array-like or buffer-like or promise of these"),
                "string" != typeof t.resolvedUrl && Be(!1, "resolvedUrl must be string"))
              const e = t.resolvedUrl,
                o = await t.buffer,
                n = new Uint8Array(o)
              ;(pe(t), await Ue.beforeOnRuntimeInitialized.promise, Ue.instantiate_asset(t, e, n))
            }
          } else
            J[t.behavior]
              ? ("symbols" === t.behavior && (await Ue.instantiate_symbols_asset(t), pe(t)),
                J[t.behavior] && ++Pe.actual_downloaded_assets_count)
              : (t.isOptional || Be(!1, "Expected asset to have the downloaded buffer"),
                !H[t.behavior] && G(t) && Pe.expected_downloaded_assets_count--,
                !Z[t.behavior] && G(t) && Pe.expected_instantiated_assets_count--)
        },
        r = [],
        i = []
      ...
      ;(Promise.all(r)
        ...
        Promise.all(i)
          .then(async () => {
            Ce || (await Ue.coreAssetsInMemory.promise, Ue.allAssetsInMemory.promise_control.resolve())
          })
          .catch((e) => {
            throw (Pe.err("Error in mono_download_assets: " + e), Xe(1, e), e)
          }))
...
function re() {
  ...
  if (e.assets)
    for (const t of e.assets)
      ("object" != typeof t && Be(!1, `asset must be object, it was ${typeof t} : ${t}`),
        "string" != typeof t.behavior && Be(!1, "asset behavior must be known string"),
        "string" != typeof t.name && Be(!1, "asset name must be string"),
        t.resolvedUrl && "string" != typeof t.resolvedUrl && Be(!1, "asset resolvedUrl could be string"),
        t.hash && "string" != typeof t.hash && Be(!1, "asset resolvedUrl could be string"),
        t.pendingDownload && "object" != typeof t.pendingDownload && Be(!1, "asset pendingDownload could be object"),
    ...
    ;(o.wasmNative || Be(!1, "resources.wasmNative must be defined"),
      ...
      o.jsModuleDiagnostics && K(t, o.jsModuleDiagnostics, "js-module-diagnostics"))
    const n = (e, t, o) => {
      const n = e
      ;((n.behavior = t), o ? ((n.isCore = !0), $.push(n)) : z.push(n))
    }
    if (o.coreAssembly) for (let e = 0; e < o.coreAssembly.length; e++) n(o.coreAssembly[e], "assembly", !0)
    if (o.assembly) for (let e = 0; e < o.assembly.length; e++) n(o.assembly[e], "assembly", !o.coreAssembly)
    if (0 != e.debugLevel && Pe.isDebuggingSupported()) {
      if (o.corePdb) for (let e = 0; e < o.corePdb.length; e++) n(o.corePdb[e], "pdb", !0)
      if (o.pdb) for (let e = 0; e < o.pdb.length; e++) n(o.pdb[e], "pdb", !o.corePdb)
    }
    ...
    if (o.coreVfs) for (let e = 0; e < o.coreVfs.length; e++) n(o.coreVfs[e], "vfs", !0)
    if (o.vfs) for (let e = 0; e < o.vfs.length; e++) n(o.vfs[e], "vfs", !o.coreVfs)
    const r = O(e)
    if (r && o.icu)
    ...
    if (o.wasmSymbols) for (let e = 0; e < o.wasmSymbols.length; e++) n(o.wasmSymbols[e], "symbols", !1)
  }
  if (e.appsettings)
    for (let t = 0; t < e.appsettings.length; t++) {
      const o = e.appsettings[t],
        n = he(o)
      ;("appsettings.json" !== n && n !== `appsettings.${e.applicationEnvironment}.json`) ||
        z.push({ name: o, behavior: "vfs", cache: "no-cache", useCredentials: !0 })
    }
  e.assets = [...$, ...z, ...t]
}
async function ie(e) {
...
async function se(e) {
  try {
    ...
    try {
      return (Pe.diagnosticTracing && b(`Retrying download '${e.name}'`), await ae(e))
    } catch (t) {
      return (
        (e.pendingDownloadInternal = void 0),
        await new Promise((e) => globalThis.setTimeout(e, 100)),
        Pe.diagnosticTracing && b(`Retrying download (2) '${e.name}' after delay`),
        await ae(e)
      )
    }
  }
...
async function ae(e) {
  ...
  try {
    ;(++N,
      N == Pe.maxParallelDownloads && (Pe.diagnosticTracing && b("Throttling further parallel downloads"), (L = i())))
    const t = await (async function (e) {
      ...
      const t = e.loadRemote && Pe.config.remoteSources ? Pe.config.remoteSources : [""]
      let o
      for (let n of t) {
        ;((n = n.trim()), "./" === n && (n = ""))
        const t = le(e, n)
        e.name === t
          ...
          : Pe.diagnosticTracing && b(`Attempting to download '${t}' for ${e.name}`)
        try {
          e.resolvedUrl = t
          const n = fe(e)
      ...
      const n = e.isOptional || (e.name.match(/\.pdb$/) && Pe.config.ignorePdbLoadErrors)
      ...
      y(`optional download '${o.url}' for ${e.name} failed ${o.status} ${o.statusText}`)
    })(e)
    return t ? (J[e.behavior] || ((e.buffer = await t.arrayBuffer()), ++Pe.actual_downloaded_assets_count), e) : e
  } finally {
...
function le(e, t) {
  ...
  return (
    ...
    (o && "string" == typeof o) || Be(!1, "attemptUrl need to be path or url string"),
    o
  )
}
function ce(e, t) {
...
function fe(e) {
  try {
    ...
    const t = (function (e) {
        ...
        const o = {}
        return (
          e.cache ? (o.cache = e.cache) : Pe.config.disableNoCacheFetch || (o.cache = "no-cache"),
          e.useCredentials
            ? (o.credentials = "include")
            : !Pe.config.disableIntegrityCheck && e.hash && (o.integrity = e.hash),
          Pe.fetch_like(t, o)
        )
      })(e),
    ...
    return (
      ...
      o.response.then(() => {
        ;("assembly" == e.behavior && Pe.loadedAssemblies.push(e.name),
          de++,
          Pe.onDownloadResourceProgress && Pe.onDownloadResourceProgress(de, ue.size))
      }),
      o
    )
  } catch (t) {
        ...
        (async function (e) {
          try {
            ...
            if (!e.moduleExports) {
              ...
              ;(Pe.diagnosticTracing && b(`Attempting to import '${o}' for ${e}`),
                (e.moduleExports = await import(/*! webpackIgnore: true */ o)))
            }
            Pe.libraryInitializers.push({ scriptName: t, exports: e.moduleExports })
          } catch (t) {
...
async function ye(e, t, o) {
  try {
    ...
    throw (E(`Failed to invoke '${t}' on library initializer '${e}': ${o}`), Xe(1, o), o)
  }
}
function ve(e, t) {
  if (e === t) return e
...
function Ee(e, t) {
  if (e === t) return e
  const o = { ...t }
  return (o.config && (e.config || (e.config = {}), (o.config = ve(e.config, o.config))), Object.assign(e, o))
}
function _e(e, t) {
  if (e === t) return e
  const o = { ...t }
  return (
    void 0 !== o.coreAssembly && (o.coreAssembly = [...(e.coreAssembly || []), ...(o.coreAssembly || [])]),
    void 0 !== o.assembly && (o.assembly = [...(e.assembly || []), ...(o.assembly || [])]),
    void 0 !== o.lazyAssembly && (o.lazyAssembly = [...(e.lazyAssembly || []), ...(o.lazyAssembly || [])]),
    void 0 !== o.corePdb && (o.corePdb = [...(e.corePdb || []), ...(o.corePdb || [])]),
    void 0 !== o.pdb && (o.pdb = [...(e.pdb || []), ...(o.pdb || [])]),
    void 0 !== o.jsModuleWorker && (o.jsModuleWorker = [...(e.jsModuleWorker || []), ...(o.jsModuleWorker || [])]),
    void 0 !== o.jsModuleNative && (o.jsModuleNative = [...(e.jsModuleNative || []), ...(o.jsModuleNative || [])]),
    void 0 !== o.jsModuleDiagnostics &&
      (o.jsModuleDiagnostics = [...(e.jsModuleDiagnostics || []), ...(o.jsModuleDiagnostics || [])]),
    void 0 !== o.jsModuleRuntime && (o.jsModuleRuntime = [...(e.jsModuleRuntime || []), ...(o.jsModuleRuntime || [])]),
    ...
    void 0 !== o.modulesAfterConfigLoaded &&
      (o.modulesAfterConfigLoaded = [...(e.modulesAfterConfigLoaded || []), ...(o.modulesAfterConfigLoaded || [])]),
    void 0 !== o.modulesAfterRuntimeReady &&
      (o.modulesAfterRuntimeReady = [...(e.modulesAfterRuntimeReady || []), ...(o.modulesAfterRuntimeReady || [])]),
...
function xe() {
  ...
  if (
    ...
    Pe.diagnosticTracing && b("config.assets is deprecated, use config.resources instead")
    for (const t of e.assets) {
      const o = {}
      switch (t.behavior) {
        case "assembly":
        ...
        case "pdb":
          ...
          break
        case "resource":
          ;((o.satelliteResources = {}), (o.satelliteResources[t.culture] = [t]))
          break
        case "icu":
          o.icu = [t]
          break
  ...
  ;(e.debugLevel,
    ...
    (Pe.maxParallelDownloads = e.maxParallelDownloads || Pe.maxParallelDownloads),
    (Pe.enableDownloadRetry = void 0 !== e.enableDownloadRetry ? e.enableDownloadRetry : Pe.enableDownloadRetry))
}
let je = !1
async function Re(e) {
  var t
  ...
  try {
    if (
      (e.configSrc ||
        (Pe.config && 0 !== Object.keys(Pe.config).length && (Pe.config.assets || Pe.config.resources)) ||
      ...
      o &&
        ...
        await (async function (e) {
          const t = e.configSrc,
            o = Pe.locateFile(t)
          let n = null
          void 0 !== Pe.loadBootResource && (n = Pe.loadBootResource("manifest", t, o, "", "manifest"))
          let r,
            i = null
          if (n)
            if ("string" == typeof n)
              n.includes(".json") ? ((i = await s(I(n))), (r = await Ae(i))) : (r = (await import(I(n))).config)
            else {
              const e = await n
              "function" == typeof e.json ? ((i = e), (r = await Ae(i))) : (r = e.config)
            }
          else
            o.includes(".json")
          ...
          function s(e) {
            return Pe.fetch_like(e, { method: "GET", credentials: "include", cache: "no-cache" })
          }
          ;(Pe.config.applicationEnvironment && (r.applicationEnvironment = Pe.config.applicationEnvironment),
            ve(Pe.config, r))
        })(e)),
      xe(),
      await we(null === (t = Pe.config.resources) || void 0 === t ? void 0 : t.modulesAfterConfigLoaded),
    ...
    throw (
      (Pe.config = e.config = Object.assign(Pe.config, { message: n, error: t, isError: !0 })), Xe(1, new Error(n)), t
    )
  }
}
function Te() {
...
async function Ae(e) {
  ...
  ;(t.applicationEnvironment ||
    ...
    (o.applicationEnvironment = e.headers.get("Blazor-Environment") || e.headers.get("DotNet-Environment") || void 0),
...
function He() {
  ;(Ve() &&
    ...
    Ue.runtimeReady || Be(!1, ".NET runtime didn't start yet. Please call dotnet.create() first."))
}
function Je() {
  ke && (globalThis.addEventListener("unhandledrejection", et), globalThis.addEventListener("error", tt))
}
let Ze, Qe
function Ge(e) {
...
function Xe(t, o) {
  ...
  const l = !!o.silent
  if (((o.silent = !0), Ve())) Pe.diagnosticTracing && b("mono_exit called after exit")
  else {
    try {
      ;(We.onAbort == Ke && (We.onAbort = Ze),
        We.onExit == Ge && (We.onExit = Qe),
        ke && (globalThis.removeEventListener("unhandledrejection", et), globalThis.removeEventListener("error", tt)),
        Ue.runtimeReady
          ? (Ue.jiterpreter_dump_stats && Ue.jiterpreter_dump_stats(!1),
            0 === t &&
              (null === (n = Pe.config) || void 0 === n ? void 0 : n.interopCleanupOnExit) &&
              Ue.forceDisposeProxies(!0, !0),
            e && 0 !== t && (null === (r = Pe.config) || void 0 === r || r.dumpThreadsOnNonZeroExit))
    ...
    try {
      l ||
                ...
                t.message
                  ? e(
                      Ue.stringify_as_error_with_stack
                        ? Ue.stringify_as_error_with_stack(t.message + "\n" + t.stack)
                        : t.message + "\n" + t.stack
                    )
                  : e(JSON.stringify(t)))
          }
        ...
        (function (e) {
          if (ke && !Ce && Pe.config && Pe.config.appendElementOnExit && document) {
    ...
    ;((Pe.exitCode = t), Pe.exitReason || (Pe.exitReason = o), !Ce && Ue.runtimeReady && We.runtimeKeepalivePop())
  }
...
function Ye(e, t) {
  if (Ue.runtimeReady && Ue.nativeExit)
    try {
      ...
      !Ue.ExitStatus || e instanceof Ue.ExitStatus || E("set_exit_code_and_quit_now failed: " + e.toString())
    }
  if (0 !== e || !ke) throw (Se && Ne.process ? Ne.process.exit(e) : Ue.quit && Ue.quit(e, t), t)
}
function et(e) {
  ...
  if (!at) {
    ...
    await (async function (e) {
      ...
      if (
        ...
        (Pe.scriptDirectory = (n = Pe.scriptUrl).slice(0, n.lastIndexOf("/")) + "/"),
        (Pe.locateFile = (e) =>
        ...
        t && t.length > 0
          ...
          : e.userAgent &&
            ((Pe.isChromium = e.userAgent.includes("Chrome")), (Pe.isFirefox = e.userAgent.includes("Firefox")))
      }
      ;((Ne.require = Se
    ...
    We.ENVIRONMENT_IS_PTHREAD
                  ...
                  st
                    ...
                    : (ve(Pe.config, n),
                      ...
                      ke &&
                        ...
                        void 0 !== globalThis.WebSocket &&
                        Pe.setup_proxy_console("worker-idle", console, globalThis.location.origin)),
                  t.close(),
                  o.close())
              },
              { once: !0 }
      ...
      : (async function () {
          ...
          ;((async function () {
            try {
              ...
              const t = await e.pendingDownloadInternal.response,
                o = t.headers && t.headers.get ? t.headers.get("Content-Type") : void 0
              let n
              if ("function" == typeof WebAssembly.compileStreaming && "application/wasm" === o)
                ...
                ;(Pe.diagnosticTracing && b("instantiate_wasm_module buffered"),
                  (n = Ie ? await Promise.resolve(new WebAssembly.Module(e)) : await WebAssembly.compile(e)))
              }
          ...
          return (
            ...
            await we(null === (e = Pe.config.resources) || void 0 === e ? void 0 : e.modulesAfterRuntimeReady),
...
function dt() {
  ...
  ;("object" == typeof e.moduleExports
    ? (nt = e.moduleExports)
    : (Pe.diagnosticTracing && b(`Attempting to import '${e.resolvedUrl}' for ${e.name}`),
      (nt = import(/*! webpackIgnore: true */ e.resolvedUrl))),
    "object" == typeof t.moduleExports
      ? (rt = t.moduleExports)
      : (Pe.diagnosticTracing && b(`Attempting to import '${t.resolvedUrl}' for ${t.name}`),
  ...
  return (
    o &&
      ("object" == typeof o.moduleExports
        ? (it = o.moduleExports)
        : (Pe.diagnosticTracing && b(`Attempting to import '${o.resolvedUrl}' for ${o.name}`),
...
const ft = new (class {
    ...
    withConfigSrc(e) {
      try {
        return ((e && "string" == typeof e) || Be(!1, "must be file path or URL"), Ee(We, { configSrc: e }), this)
      } catch (e) {
        throw (Xe(1, e), e)
      }
    }
    withVirtualWorkingDirectory(e) {
      try {
        return (
          (e && "string" == typeof e) || Be(!1, "must be directory path"), ve(ze, { virtualWorkingDirectory: e }), this
        )
      } catch (e) {
        throw (Xe(1, e), e)
      }
    ...
    withEnvironmentVariables(e) {
      try {
        return (
          (e && "object" == typeof e) || Be(!1, "must be dictionary object"), ve(ze, { environmentVariables: e }), this
        )
      } catch (e) {
        throw (Xe(1, e), e)
      }
    ...
    withDiagnosticTracing(e) {
      try {
        return ("boolean" != typeof e && Be(!1, "must be boolean"), ve(ze, { diagnosticTracing: e }), this)
      } catch (e) {
        throw (Xe(1, e), e)
      }
    }
    withDebugging(e) {
      try {
        return ((null != e && "number" == typeof e) || Be(!1, "must be number"), ve(ze, { debugLevel: e }), this)
      } catch (e) {
        throw (Xe(1, e), e)
      }
    }
    withApplicationArguments(...e) {
      try {
        return (
          (e && Array.isArray(e)) || Be(!1, "must be array of strings"), ve(ze, { applicationArguments: e }), this
        )
      } catch (e) {
        throw (Xe(1, e), e)
      }
    ...
    withRuntimeOptions(e) {
      try {
        return (
          ...
          ze.runtimeOptions ? ze.runtimeOptions.push(...e) : (ze.runtimeOptions = e),
          this
        )
      } catch (e) {
        throw (Xe(1, e), e)
    ...
    withApplicationArgumentsFromQuery() {
      try {
        ...
        const e = new URLSearchParams(globalThis.window.location.search).getAll("arg")
    ...
    async download() {
      try {
        await (async function () {
          ;(lt(We), await Re(We), re(), D(), oe(), await Pe.allDownloadsFinished.promise)
        })()
      } catch (e) {
        throw (Xe(1, e), e)
      }
        ...
        coreAssembly: [
          {
            ...
            name: "System.Private.CoreLib.mrumtqmcb4.wasm",
            integrity: "sha256-Qoo9/0JvY1xGw5E4l6LUQzMj52QgnInrn7mJOmZlZZk=",
            cache: "force-cache"
          },
          {
            virtualPath: "System.Runtime.InteropServices.JavaScript.wasm",
            name: "System.Runtime.InteropServices.JavaScript.8e75t0zrd1.wasm",
            integrity: "sha256-sOFrh/XnAq0Qbp0CTsmP5jJMqMcWgqAYhyFS9s0HCtU=",
            cache: "force-cache"
          }
        ],
        assembly: [
          {
            ...
            name: "JetBrains.Annotations.3aev2xiwr2.wasm",
            integrity: "sha256-9R+tCjl9P3jFG/Kk1ys0LbA8xxzTsYJH/DfiUuKTjYQ=",
            cache: "force-cache"
          },
          {
          ...
          },
          {
            ...
            name: "System.Collections.l3j5ttptmt.wasm",
            integrity: "sha256-D28A2V1Lpqeueq85I/nHcKJFpNmYtdEXO5m6ktWeWn0=",
            cache: "force-cache"
          },
          {
            virtualPath: "System.Collections.Concurrent.wasm",
            name: "System.Collections.Concurrent.805eii3efq.wasm",
            integrity: "sha256-KGXt91oFdKPCSKdHzqm+XJHIJT2XF8Lp7IJkn9ue9BE=",
            cache: "force-cache"
          },
          {
            virtualPath: "System.Collections.Immutable.wasm",
            name: "System.Collections.Immutable.4qcmv2gwsk.wasm",
            integrity: "sha256-FE+rzBCfhfb9d6SEPNFC9zWgpxEx9sLFZ8Am7vdG4hQ=",
            cache: "force-cache"
          },
          {
            virtualPath: "System.IO.Pipelines.wasm",
            name: "System.IO.Pipelines.97rb36985s.wasm",
            integrity: "sha256-daljQSLhxmd/VCSWIb+96dVUsblw594Nk8Qr1XqExjE=",
            cache: "force-cache"
          },
          {
            virtualPath: "System.Linq.wasm",
            name: "System.Linq.upcbygjr8o.wasm",
            integrity: "sha256-IqcgmkXuRzYzLvpP1KrZavFDwrt8tLes+HEH9lMdwE4=",
            cache: "force-cache"
          },
          {
            virtualPath: "System.Memory.wasm",
            name: "System.Memory.ltgc9vzhm5.wasm",
            integrity: "sha256-1ypbv/nmBiq3rtXf4aYunYnXvl18k1CBdUdZgFpv3LU=",
            cache: "force-cache"
          },
          {
            virtualPath: "System.Runtime.Numerics.wasm",
            name: "System.Runtime.Numerics.360ruffezm.wasm",
            integrity: "sha256-myMoW5mJt6MSrOEdQbUw+t/40lr3OyMQI7WrnUiM48g=",
            cache: "force-cache"
          },
          {
            virtualPath: "System.Security.Cryptography.wasm",
            name: "System.Security.Cryptography.6cibpjxedm.wasm",
            integrity: "sha256-alk/IyhIEQaMLdbxIGTuDOJLqpFQ9RFY732gX68OFHI=",
            cache: "force-cache"
          },
          {
            virtualPath: "System.Text.Encodings.Web.wasm",
            name: "System.Text.Encodings.Web.ug0k51f2hr.wasm",
            integrity: "sha256-oodLVJ4druLj8lG6WpvJPhS4ER1Km+xcwLXUR9kzfBI=",
            cache: "force-cache"
          },
          {
            virtualPath: "System.Text.Json.wasm",
            name: "System.Text.Json.ewjujhjeiy.wasm",
            integrity: "sha256-wrieaydeVhHLgy1WnHKRYJJQU1P/RLz/8tiRACLyr6A=",
            cache: "force-cache"
          },
          {
            virtualPath: "System.Text.RegularExpressions.wasm",
            name: "System.Text.RegularExpressions.dptwl4z6p9.wasm",
            integrity: "sha256-nyyC/38xWfCeejcbWlO5TCZkb7bRDstbkilXrn98OAU=",
            cache: "force-cache"
          }
        ]
      },
