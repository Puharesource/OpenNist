...
export const nistInspectorContent = {
  ...
  summary:
    "Example field details for a future NIST inspector, shown in the same sidebar style as the other app pages.",
  accentValue: "1243",
      ...
      items: [
        {
          label: "Description",
          value:
            "The record length includes the tag, value, field separator, and record separator characters.",
        },
      ],
    },
  ],
